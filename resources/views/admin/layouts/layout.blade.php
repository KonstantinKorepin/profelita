...
<head>
    ...
    <title>Профэлита | Административная панель</title>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ route('admin.index') }}" class="brand-link">
            ...
            <span class="brand-text font-weight-light">Профэлита</span>
        </a>
    ...
    <footer class="main-footer">
        <strong>{{ date('Y') }} <a href="https://adminlte.io">AdminLTE.io</a>.</strong>
